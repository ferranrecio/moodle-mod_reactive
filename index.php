...
/**
 * Display information about all the mod_reactive modules in the requested course.
 *
...
$event = \mod_reactive\event\course_module_instance_list_viewed::create(['context' => $coursecontext]);
