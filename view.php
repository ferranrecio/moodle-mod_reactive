...
/**
 * Prints an instance of mod_reactive.
 *
...
list($course, $cm) = get_course_and_cm_from_cmid($id, 'reactive');
...
$PAGE->set_url('/mod/reactive/view.php', ['id' => $cm->id]);
...
if (!empty($instance->intro)) {
    echo $OUTPUT->box(format_module_intro('reactive', $instance, $cm->id), 'generalbox', 'intro');
}

$widget = new mod_reactive\output\content($manager);
